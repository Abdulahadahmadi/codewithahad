  ...
  return (
    <div className='mx-auto'>
      ...
      <div className='grid lg:grid-cols-3 md:gap-5 mx-10 '>
        ...
        <section className='w-72 h-72 md:w-96 md:h-96 rounded-xl shadow-xl p-10 md:p-16 leading-3 md:mx-20 my-7 lg:my-16 mx-auto hover:bg-cyan-500 cursor-pointer hover:rotate-6' data-aos="flip-right">
