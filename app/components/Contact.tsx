  ...
  return (
    <div className='flex flex-col md:flex-row md:justify-around items-center bg-gradient-to-r from-violet-500 to-fuchsia-500 w-full p-10 mx:p-20'>
      ...
      <section className=' md:leading-8'>
        ...
        <Link href='/contact' passHref className='px-6 md:px-10 ring-1 py-2 md:py-3 bg-cyan-500 hover:bg-cyan-500 hover:rounded-full hover:transition-all hover:text-white rounded-md'>
            Contact
        </Link>
      </section>
    </div>
