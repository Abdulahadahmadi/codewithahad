...
const Page = ({ }: Props) => {
  ...
  return (
    <div className="flex justify-center items-center md:py-20 md:px-20">
      {/* Register Section */}
      <div className="w-full flex flex-row justify-center items-center  rounded-md">
        <div className="flex flex-col justify-center md:justify-start pt-8 md:pt-0 md:px-24 lg:px-32">
          <p className="text-center text-3xl">Login</p>
          <p className="">Create free account and start to write first blog!!</p>
          {/* form */}
          <form className="flex flex-col mx-auto pt-3 md:pt-5" onSubmit={handleSubmit}>
            <div className="flex flex-col pt-4">
              ...
              <input
                ...
                className="shadow appearance-none border rounded w-full py-2 px-3 focus:ring-1 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline placeholder:text-sm"
              />
            </div>
