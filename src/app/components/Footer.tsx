...
const Footer = () => {
  return (
    <div className='bg-gray-200 w-full p-10 md:p-28'>
     <div className='flex flex-col md:flex-row justify-between'>
        <div className='mb-16'>
            ...
            <span className='mt-3'>Code With Ahad</span>
        </div>
          ...
          <div>
            ...
            <ul className='flex flex-row text-gray-600 gap-6 mt-4 text-sm md:text-base'>
      ...
      <span className='flex justify-center items-center text-gray-500 md:text-lg'>&copy; Copyright {new Date().getFullYear()} | All rights reserved by Code With Ahad</span>
    </div>
  )
} 
