...
const Service = () => {
  return (
    <div>
      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-3 md:gap-5 mx-10 md:ml-28'>
        <section className='bg-gray-100 w-72 h-72 md:w-96 md:h-96 rounded-xl shadow-xl py-10 md:p-16 leading-3 my-7 md:my-16 hover:bg-cyan-500 cursor-pointer hover:rotate-6'>
        ...
        <section className='bg-gray-100 w-72 h-72 md:w-96 md:h-96 rounded-xl shadow-xl p-10 md:p-16 leading-3 md:mx-20 my-7 md:my-16 hover:bg-cyan-500 cursor-pointer hover:rotate-6'>
          ...
          <p className='text-center leading-5 mt-3 overflow-auto'>Empowering Your Mobile Vision: Seamless App Development, Simplified From Concept to Completion: Building Intuitive Apps for Today's Digital Landscape.</p>
        </section>
      </div>
      </div>  
    </div>
